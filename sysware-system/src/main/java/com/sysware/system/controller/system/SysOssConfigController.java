...
public class SysOssConfigController extends BaseController {
     ...
     */
    @PostMapping("/list")
    public TableDataInfo list(@RequestBody Map<String, Object> params, @RequestBody PageQuery pageQuery) {
        return iSysOssConfigService.queryPageList(params, pageQuery);
    }
