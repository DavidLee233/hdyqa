  ...
  <div>
    <el-row>
      ...
      <el-radio-group v-model="dataType" @change="changeDataType">
        ...
        <el-radio label="ROLES">系统角色</el-radio>
        <el-radio label="PROJECTROLES">项目角色</el-radio>
      ...
      <el-row type="flex" :gutter="20">
        ...
        <el-col :span="17">
          <el-table ref="multipleTable" height="600" :data="userTableList" border @selection-change="handleSelectionChange">
            ...
            <el-table-column label="工号" align="center" prop="loginName" />
          </el-table>
          <pagination
            :total="userTotal"
...
export default {
  ...
  methods: {
    ...
    handleNodeClick(data) {
      ...
      if(data.id ==='100'){
        this.queryParams.searchField = null;
      }else{
        this.queryParams.searchField = 'deptId' ;
      }
      this.getUserList();
    },
    // 关闭标签
    handleClose(tag) {
      console.log(this.selectedUserDate)
