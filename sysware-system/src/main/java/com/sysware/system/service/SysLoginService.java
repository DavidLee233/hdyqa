...
import com.sysware.common.core.domain.model.XcxLoginUser;
import com.sysware.common.enums.DeviceType;
import com.sysware.common.enums.LoginType;
import com.sysware.common.enums.UserStatus;
import com.sysware.common.exception.user.CaptchaException;
import com.sysware.common.exception.user.CaptchaExpireException;
import com.sysware.common.exception.user.UserException;
import com.sysware.common.helper.LoginHelper;
import com.sysware.common.utils.DateUtils;
import com.sysware.common.utils.MessageUtils;
...
public class SysLoginService {
    ...
    private SysUser loadUserByUsername(String username) {
        SysUser user = userMapper.selectOne(new LambdaQueryWrapper<SysUser>()
            .select(SysUser::getLoginName, SysUser::getStatus)
    ...
    private LoginUser buildLoginUser(SysUser user) {
        ...
        loginUser.setUsername(user.getUserName());
        loginUser.setLoginName(user.getLoginName());
        SysUserConfig config = userConfigMapper.selectByUserId(user.getUserId());
        if (config != null){
            loginUser.setOpenNotify(config.getOpenNotify());
        }
        loginUser.setMenuPermission(permissionService.getMenuPermission(user));
        loginUser.setRolePermission(permissionService.getRolePermission(user));
        loginUser.setDeptName(ObjectUtil.isNull(user.getDept()) ? "" : user.getDept().getDeptName());
        loginUser.setSecurityName(user.getSecurityName());
        loginUser.setSecurityValue(user.getSecurityValue());
        loginUser.setSecurityId(user.getSecurityId());
