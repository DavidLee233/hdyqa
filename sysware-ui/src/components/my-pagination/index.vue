<template>
  ...
  >
    <template #default>
      <span v-if="checkedCount>0 " class="el-pagination__total">，已选 {{ checkedCount }} 条，共{{pageCount}}页，当前显示第 {{ page }} 页</span>
    </template>
  </my-el-pagination>
</template>
...
const layouts = {
  ...
  simple: 'prev, next',
  simpleJumper: 'total,prev, jumper, next',
  onlyTotal:'total'
}
export default {
  name: 'MyPagination',
