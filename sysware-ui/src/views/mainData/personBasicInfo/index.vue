...
<script>
import { listPersonBasicInfo, getPersonBasicInfo, delPersonBasicInfo, addPersonBasicInfo, updatePersonBasicInfo } from "@/api/mainData/personBasicInfo";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listPersonBasicInfo(this.queryParams).then(response => {
        this.personBasicInfoList = response.rows;
    ...
    handleExport() {
      this.$confirm('是否确认导出所有数据项?', "警告", {
        ...
        this.download('/mainData/personBasicInfo/export', {
          ...this.queryParams
        }, `员工基本信息数据表_${new Date().getTime()}.xlsx`)
      }).catch(() => {
