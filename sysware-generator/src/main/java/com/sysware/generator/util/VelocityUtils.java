package com.sysware.generator.util;
...
import com.sysware.common.helper.DataBaseHelper;
...
public class VelocityUtils {
    ...
    public static String getFileName(String template, GenTable genTable) {
        ...
        String javaPath = "sysware-"+moduleName+ "/src/" +  PROJECT_PATH + "/" + StringUtils.replace(packageName, ".", "/");
        String mybatisPath ="sysware-"+moduleName+ "/src/" +  MYBATIS_PATH + "/" + moduleName;
        String vuePath = "sysware-ui/src";
