<template>
  ...
  <el-input placeholder="请选择文件" v-model="fileName" clearable @clear="handleClear"  @input="changeValue" :disabled="disabled" :class="defaultClass">
    <template slot="append">
      ...
      >
        <el-button slot="trigger"  icon="el-icon-paperclip">本地上传</el-button>
        <el-button style="margin-left: 10px;"  icon="el-icon-search" @click="handelSeleteTemp">线上模板</el-button>
      </el-upload>
    </template>
  </el-input>
  ...
  methods: {
    ...
    handleUploadSuccess(res, file) {
      ...
      if(res.code === 200){
        ...
        this.$emit("update:value",res.data.fileId);
