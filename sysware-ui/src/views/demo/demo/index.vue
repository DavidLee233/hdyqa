<template>
  <div ref="tableDiv" class="app-container">
    ...
    <el-table v-loading="loading" :max-height="tableHeight" :data="demoList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="id" v-if="false"/>
      <el-table-column label="tableHeight" align="center" prop="deptId" />
