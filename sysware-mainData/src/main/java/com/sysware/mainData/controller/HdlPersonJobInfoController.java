...
public class HdlPersonJobInfoController extends BaseController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(HdlPersonJobInfoController.class);
    ...
    public RemoteTableDataInfo listRemote(@RequestBody Map<String, Object> params) {
        ...
        try {
            ...
            if (safeParams.get("keyNumber") != null) queryParams.put("keyNumber", safeParams.get("keyNumber"));
            ...
            logger.error("查询远端员工工作信息失败，参数={}", safeParams, e);
            return MainDataRemoteControllerSupport.buildRemoteError(pageQuery, "查询远端员工工作信息失败", e);
        }
    }
    /**
    ...
    public void exportRemote(@RequestParam(required = false) Map<String, String> params,
        ...
        try {
            ...
            MainDataRemoteControllerSupport.writeExcelResponse(response, data, "remote_person_job_info");
        } catch (Exception e) {
            logger.error("导出远端员工工作信息失败，参数={}，请求体={}", params, body, e);
    ...
    public R<Map<String, Object>> forceSyncRemote(@RequestBody(required = false) Map<String, Object> body) {
        try {
            ...
            String message = MainDataRemoteControllerSupport.resolveSyncFailureMessage(result, "强制同步员工工作信息失败");
