package com.sysware.common.helper;
...
import com.sysware.common.enums.UserType;
...
public class LoginHelper {
     ...
     * 获取消息提醒状态
     */
    public static Integer getNotify() {
        return getLoginUser().getOpenNotify();
    }
    ...
    public static String getSecurityName() {
        return getLoginUser().getSecurityName();
    }
    /**
     * 获取用户密级值
     */
    public static Integer getSecurityValue() {
        return getLoginUser().getSecurityValue();
    }
    /**
     * 获取用户密级ID
     */
    public static String getSecurityId() {
        return getLoginUser().getSecurityId();
    }
